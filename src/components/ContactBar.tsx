...
const ContactBar: React.FC<ContactBarProps> = ({ visible = true }) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white shadow-[0_-2px_10px_rgba(0,0,0,0.1)] z-40 py-2 animate-fadeIn" style={{marginBottom: 0, paddingBottom: 0}}>
      <div className="container mx-auto">
        <div className="flex justify-around items-center">
          ...
          >
            <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-[#1a3f6e] flex items-center justify-center mb-1 shadow-md">
